                ...
                <div class="container-flex">
                    <div class="grid__column-8">
                        <div style="background-color: var(--white-color);">
                            ...
                            <h4 class="container-mini-main">Tìm thấy <span style="color:var(--primary-color) ;"> 60</span> việc làm phù hợp với yêu cầu của bạn</h4>

                            <div class="container-vieclam">
                                <div class="container-vieclam-chitiet">
                                    <img src="https://www.topcv.vn/v3/images/topcv-logo-gray.png" alt="">
                                    <div style="display: flex; justify-content: space-between; width: 100%;">
                                        <div style="padding-left: 15px;">
                                            <p class="vieclam-chucvu">Nhân viên kinh doanh</p>
                                            <p class="vieclam-congty">CTY TNHH THƯƠNG MẠI HUY PHƯƠNG</p>
                                        </div>
                                ...
                                <div class="container-vieclam-chitiet">
                                    <img src="https://cdn.topcv.vn/80/company_logos/nFzhqAxu7GiygetKmucDaPWHzbBFLSjR_1652929797____0dca30b0e08cebc1f95ca9aa3146e6f1.png" alt="">
                                    <div style="display: flex; justify-content: space-between; width: 100%;">
                                        <div style="padding-left: 15px;">
                                            <p class="vieclam-chucvu">Nhân viên kinh doanh</p>
                                            <p class="vieclam-congty">CÔNG TY CỔ PHẦN THƯƠNG MẠI ĐIỆN TỬ TECOTEC</p>
                                        </div>
                                        <div style="font-size:1.2rem ;">
                                            <p>Còn <span>4</span> để ứng tuyển</p>
                                            <div class="vieclam-icon">
                                                <i class="ti-heart " ></i>
                                                <i class="ti-trash " ></i>
                                            </div>
                                ...
                                <div class="container-vieclam-chitiet">
                                    ...
                                    <div style="display: flex; justify-content: space-between; width: 100%;">
                                        <div style="padding-left: 15px;">
                                            <p class="vieclam-chucvu">Nhân viên kinh doanh</p>
                                            <p class="vieclam-congty">CÔNG TY CỔ PHẦN KINH DOANH THƯƠNG MẠI XUẤT NHẬP KHẨU VIỆT NAM</p>
                                        </div>
                                        <div style="font-size:1.2rem ;">
                                            <p>Còn <span>26</span> để ứng tuyển</p>
                                            <div class="vieclam-icon">
                                                <i class="ti-heart " ></i>
                                                <i class="ti-trash " ></i>
                                            </div>
                                ...
                                <div class="container-vieclam-chitiet">
                                    <img src="https://cdn.topcv.vn/80/company_logos/pWOejmd7W6ZfSq2qVDRHOhg69amf99IX_1638757418____1e294453cfb4a9fd05c0202a56e4ae63.png" alt="">
                                    <div style="display: flex; justify-content: space-between; width: 100%;">
                                        <div style="padding-left: 15px;">
                                            <p class="vieclam-chucvu">Nhân Viên Kinh Doanh Thị Trường </p>
                                            <p class="vieclam-congty">CÔNG TY CỔ PHẦN NHỰA THIẾU NIÊN TIỀN PHONG PHÍA NAM</p>
                                        </div>
                                        <div style="font-size:1.2rem ;">
                                            <p>Còn <span>12</span> để ứng tuyển</p>
                                            <div class="vieclam-icon">
                                                <i class="ti-heart " ></i>
                                                <i class="ti-trash " ></i>
                                            </div>
                                ...
                                <div class="container-vieclam-chitiet">
                                    <img src="https://cdn.topcv.vn/80/company_logos/cong-ty-co-phan-vien-thong-fpt-5c3714e30b969_rs.jpg" alt="">
                                    <div style="display: flex; justify-content: space-between; width: 100%;">
                                        <div style="padding-left: 15px;">
                                            <p class="vieclam-chucvu">
                                                Nhân Viên Kinh Doanh Tại Huế</p>
                                            <p class="vieclam-congty">CÔNG TY CỔ PHẦN VIỄN THÔNG FPT
