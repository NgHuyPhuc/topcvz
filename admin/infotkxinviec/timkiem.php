...
if (isset($_GET['name'])) {
    ...
    $sqlpt = "SELECT * 
            FROM `infocv` 
            WHERE `infocv`.`IdInfoCV` like '%$name%' OR IdAccount like '%$name%' OR FirstName like '%$name%' 
            OR LastName like '%$name%' OR DoB like '%$name%' OR Sex like '%$name%' OR Email like '%$name%' 
            OR Hometown like '%$name%' OR PermanentAddress like '%$name%' OR CityforCV like '%$name%' 
            OR WorkExperience like '%$name%' OR PhoneNumber like '%$name%' ORDER BY IdInfoCV ASC LIMIT " . $item_per_page . " OFFSET " . $offset;
    ...
    $sql = "SELECT * 
            ...
            OR LastName like '%$name%' OR DoB like '%$name%' OR Sex like '%$name%' OR Email like '%$name%' 
            OR Hometown like '%$name%' OR PermanentAddress like '%$name%' OR CityforCV like '%$name%' 
            OR WorkExperience like '%$name%' OR PhoneNumber like '%$name%' ";
