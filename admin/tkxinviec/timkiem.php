...
<?php
    ...
    $sqlpt = "SELECT * 
            from useraccountcv
            WHERE useraccountcv.IdAccount like '%$name%' OR useraccountcv.UserName like '%$name%' OR useraccountcv.Password like '%$name%' 
            ORDER BY useraccountcv.IdAccount ASC LIMIT " . $item_per_page . " OFFSET " . $offset;
