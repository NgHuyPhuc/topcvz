            ...
            <div class="grid">
                <div class="container-form-cv">
                    <div class="grid__column-7">
                        <div style="display: flex; background-color: rgba(220, 153, 153, 0.36); padding: 30px 0 ; margin-top: 30px; border: 1px solid #ccc;">
                            <div class="grid__column-5">
                                <div class="form1-trai">
                                    <div class="kinhnghiem">
                                        <h3 class="h3-form2">Kinh nghiệm làm việc</h3>
                                    ...
                                    <div class="hocvan">
                                        ...
                                        <textarea rows="4" cols="40" name="comment" form="usrform" style="font-size:1.4rem ;"> Chi tiết về các hoạt động từng tham gia...</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid__column-5">
                                ...
                                <div class="form-1_thongtin">
                                    <h3 class="h3-form2">Thông tin</h3>
                                ...
                                <div class="form1_kynang">
                                    <h3 class="h3-form2">Các kỹ năng</h3>
